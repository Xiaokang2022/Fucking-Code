...
<header class="{{ class }}" data-md-component="header">
    <nav class="md-header__inner md-grid" aria-label="{{ lang.t('header') }}">
        ...
        <audio controls="controls" loop="loop" controlsList="noplaybackrate nodownload" oncontextmenu="return false"
            src="/Fucking-Code/See You Again.mp3" title="See You Again">
        </audio>
